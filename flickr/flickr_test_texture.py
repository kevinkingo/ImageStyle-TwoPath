...
path = 'prob/'
if save:
	net = caffe.Net('flickr_test_texture_model.prototxt', 'models/flickr_texture_iter_30000.caffemodel', caffe.TEST)
	...
	np.save(path + 'flickr_test_texture.npy', probs_texture)
	np.save(path + 'flickr_test_label.npy', labels)
else:
	probs_texture = np.load(path + 'flickr_test_texture.npy')
