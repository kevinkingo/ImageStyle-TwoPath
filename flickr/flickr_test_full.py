...
path = 'prob/'
if save:
	net = caffe.Net('flickr_test_full_model.prototxt', 'models/flickr_full_iter_30000.caffemodel', caffe.TEST)
	...
	np.save(path + 'flickr_test_full_object.npy', probs_object)
	np.save(path + 'flickr_test_full_texture.npy', probs_texture)
	np.save(path + 'flickr_test_label.npy', labels)
else:
	probs_object = np.load(path + 'flickr_test_full_object.npy')
	probs_texture = np.load(path + 'flickr_test_full_texture.npy')
